...
const ConfirmPopUpRide = ({ setConfirmPopUpRidePanel, }) => {
    ...
    <div className="h-[95%]">
      <h5
        onClick={() => {
          ...
          setConfirmPopUpRidePanel(false);
        }}
        ...
        <div className="w-full">
          <form onSubmit={handleSubmit}>
            <input value={otp} onChange={(e) => setOtp(e.target.value)}
              ...
              className="bg-[#eee] px-12 py-3 text-base rounded-lg mt-5 w-full focus:outline-none mb-2 font-mono"
            />
            <Link
              to="/captain-riding"
              onClick={() => {}}
              className="w-full text-lg mt-2 bg-green-600 py-2 text-white font-semibold rounded-lg flex items-center justify-center"
            >
              Confirm
            </Link>
            ...
            <button 
              ...
              className="w-full text-lg mt-3 bg-red-500 py-2 text-white font-semibold rounded-lg"
            >
              Cancel
            </button>
          </form>
